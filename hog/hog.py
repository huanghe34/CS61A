...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        if cur_point == 1:
            ...
            score, num_rolls = score + cur_point, num_rolls - 1
    if num_ones:
        return num_ones
    else:
        return score
    ...
    while score0 < goal and score1 < goal:
        ...
        if player == 0:
            ...
            if num_rolls == -1:  # Pork Chop
                ...
                dice = select_dice(score0, score1, dice_swapped) # Hog Wild
...
def make_averaged(fn, num_samples=1000):
    ...
    def average(*args):
        n, total_result = 0, 0
        while n < num_samples:
            n, total_result = n + 1, total_result + fn(*args)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 8
    num_rolls, max_result = 1, 0
    while num_rolls <= 10:
        cur_result = make_averaged(roll_dice)(num_rolls, dice)
